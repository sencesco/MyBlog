...
{{ site.tabc }} Password Manager is a secure application designed to help users store, manage, and organize their passwords within whis application. It provides a user-friendly interface for generating and storing passwords, allowing users to easily access them when needed.
With generate a password with a random mix of letters, numbers, and symbols will help users create strong and secure passwords for their accounts. And store and retrieve passwords securely in JSON format that can access only from the application.
...
## Feature
- **Password Generation:** Automatically generate secure passwords with a mix of characters and special symbols with random length.
...
<div class="post-content-link">
    <ul>
        ...
        <a href="https://github.com/sencesco/Application/tree/main/Password%20Manager%20V.1.2.0" target="_blank" alt="GitHub-repo/Password-Manager">
            GitHub
        </a>
        </li>
    </ul>
